<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <x-forms.medical-form 
                ...
                :cancel-url="route('treatments.show', $treatment)"
            >
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="therapy" {{ old('treatment_type', $treatment->treatment_type) == 'therapy' ? 'selected' : '' }}>Therapy</option>
                            <option value="surgery" {{ old('treatment_type', $treatment->treatment_type) == 'surgery' ? 'selected' : '' }}>Surgery</option>
                            <option value="lifestyle" {{ old('treatment_type', $treatment->treatment_type) == 'lifestyle' ? 'selected' : '' }}>Lifestyle Change</option>
                            <option value="monitoring" {{ old('treatment_type', $treatment->treatment_type) == 'monitoring' ? 'selected' : '' }}>Monitoring</option>
                        </x-forms.medical-input>
                    </div>
                </div>
                ...
                <div>
                    <x-forms.medical-input 
                        ...
                        value="{{ old('description', $treatment->description) }}"
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <x-forms.medical-input 
                            ...
                            label="End Date"
                            type="date"
                            value="{{ old('end_date', $treatment->end_date ? $treatment->end_date->format('Y-m-d') : '') }}"
                            icon="fas fa-calendar"
                        />
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    >
                        ...
                        <option value="discontinued" {{ old('status', $treatment->status) == 'discontinued' ? 'selected' : '' }}>Discontinued</option>
                        <option value="pending" {{ old('status', $treatment->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                    </x-forms.medical-input>
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="space-y-4" id="medications-container">
                        @if($treatment->medications && count($treatment->medications) > 0)
                            @foreach($treatment->medications as $index => $medication)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <x-forms.medical-input 
                                ...
                                value="{{ old('instructions', $treatment->instructions) }}"
                            />
                        </div>
                        ...
                        <div>
                            <x-forms.medical-input 
                                ...
                                value="{{ old('notes', $treatment->notes) }}"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <x-forms.medical-input 
                            ...
                            type="date"
                            value="{{ old('follow_up_date', $treatment->follow_up_date ? $treatment->follow_up_date->format('Y-m-d') : '') }}"
                            icon="fas fa-calendar"
                        />
                        ...
                        <x-forms.medical-input 
                            ...
                            value="{{ old('follow_up_notes', $treatment->follow_up_notes) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let medicationCount = {{ $treatment->medications ? count($treatment->medications) : 1 }};
            ...
            // Add remove functionality to existing medications
