...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        // Get recent reports
        $recentReports = Report::where('generated_by', $user->id)
            ->orderBy('created_at', 'desc')
            ->limit(5)
            ->get();

        return view('reports.index', compact('reports', 'templates', 'recentReports'));
    }
    ...
    public function download(Report $report)
    {
        ...
        // Generate downloadable file (PDF, Excel, etc.)
